...
public class HostDetailJson {
    ...
    private RecoveryReportJson recovery_report;
    ...
    public DiskInfoJson[] getDisk_info() {
        return disk_info;
    }

    public void setDisk_info(DiskInfoJson[] disk_info) {
    ...
    public LastAgentEnvJson getLast_agent_env() {
        return last_agent_env;
    }

    public void setLast_agent_env(LastAgentEnvJson last_agent_env) {
    ...
    public RecoveryReportJson getRecovery_report() {
        return recovery_report;
    }

    public void setRecovery_report(RecoveryReportJson recovery_report) {
